...
So if person A pedals at a speed of 5, and person B pedals at a speed of 4, the tandem bicycle
moves at a speed of 5 (i.e., tandemSpeed=max(speedA, speedB) ).
...
of the tandem bicycles being ridden based on an input parameter, fastest. If fastest = true, your function
...
if there are 4 riders (2 red-shirt riders and 2 blue-shirt riders) who have speeds of 1, 3, 4, , and if
paired on tandem bicyc as follows:
...
function tandemBicycle(redShirtSpeeds, blueShirtSpeeds, fastest) {
	...
	if (fastest) {
		for (let i = 0; i < len; i++) {
			sum += Math.max(redShirtSpeeds[i], blueShirtSpeeds[len - 1 - i]);
		}
	} else {
...
// Time comp: O(n log n) -- because of sorting using javascript's quicksort implementation
// Space comp: O(1) 
